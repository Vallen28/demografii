<body>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        ...
                        <span class="d-none d-md-block dropdown-toggle ps-2">Raja</span>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="<?php echo base_url('home/logout'); ?>">
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link <?php if($location == 'dashboard'){echo "";}else{ echo "collapsed";} ?>" href="<?= base_url('dashboard'); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link <?php if($location == 'penduduk'){echo "";}else{ echo "collapsed";} ?>" href="<?= base_url('penduduk');?>">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-journal-text"></i><span>Grafika Bersdasarkan</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="forms-editors.html">
                            <i class="bi bi-circle"></i><span>Jumlah KK</span>
                        </a>
                    </li>
                    <li>
